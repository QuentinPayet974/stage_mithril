...
class ComptesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compte" do
    assert_difference('Compte.count') do
      post comptes_url, params: { compte: { identifiant: @compte.identifiant, mdp: @compte.mdp } }
    end
  ...
  test "should update compte" do
    patch compte_url(@compte), params: { compte: { identifiant: @compte.identifiant, mdp: @compte.mdp } }
