...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post classrooms_url, params: { classroom: { room_number: @classroom.room_number, students_number: @classroom.students_number } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { room_number: @classroom.room_number, students_number: @classroom.students_number } }
